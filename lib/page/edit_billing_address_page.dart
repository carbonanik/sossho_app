...
import 'package:sossho_app/providers/billing_address_provider.dart';
...
class EditBillingAddressPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditBillingAddressPage> createState() =>
      _EditBillingAddressPageState();
}

class _EditBillingAddressPageState
    extends ConsumerState<EditBillingAddressPage> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ref.read(billingAddressProvider.future).errorAsValue().then((value) {
            ...
            child: Column(
              children: [
                ...
                Consumer(builder: (context, ref, child) {
                  ...
                  return billingAddress.valueOrNull == null
                      ? Container()
                      : AppButton(
                          ...
                          onPressed: () async {
                            if (billingAddress.valueOrNull == null) {
                              return;
                            }
                            final res = await ref
                                .read(billingAddressProvider.notifier)
                                .deleteBillingAddress(
                                    addressId: billingAddress.valueOrNull!.id!);
                ...
                AppButton(
                  onPressed: () async {
                    ...
                    if (res.hasError) {
                      ...
                      if (context.mounted) {
                        showSnackBar(
                            context, 'Billing Address Saved', Colors.green);
                      }
                    }
                  },
