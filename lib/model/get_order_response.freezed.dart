...
class _$GetOrdersResponseImpl implements _GetOrdersResponse {
  ...
  @override
  String toString() {
    return 'GetOrdersResponse(id: $id, userId: $userId, deliveryAddress: $deliveryAddress, billingAddress: $billingAddress, paymentMethod: $paymentMethod, discountCode: $discountCode, discountAmount: $discountAmount, totalAmount: $totalAmount, orderStatus: $orderStatus, createdBy: $createdBy, updatedBy: $updatedBy, createdAt: $createdAt, updatedAt: $updatedAt, orderItems: $orderItems)';
  }
