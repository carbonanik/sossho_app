...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, emailVerify: $emailVerify, fullName: $fullName, dateOfBirth: $dateOfBirth, mobile: $mobile, gender: $gender, profileImage: $profileImage, password: $password, profileId: $profileId, createdBy: $createdBy, updatedBy: $updatedBy, createdAt: $createdAt, updatedAt: $updatedAt, profile: $profile)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      @JsonKey(name: "profile") final Profile? profile}) = _$UserImpl;
